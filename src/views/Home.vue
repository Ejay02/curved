  ...
  <v-app id="inspire">
    ...
    <v-container>
      <v-app-bar color="rgba(0,0,0,0)" flat>
        ...
        ></v-select>
        <span text color="#878A94">Ej</span>
          ...
          <v-card class="mx-4 rounded-xl pa-4" color="grey lighten-3" flat>
            <v-row>
              <v-col cols="12" sm="8">
                <v-list-item three-line>
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle
                      >Wecome back Ej. We are glad here.<br />
                ...
                <v-card-actions>
                  <v-btn class="px-3" color="blak" dark> View Details </v-btn>
                </v-card-actions>
              </v-col>
              <v-col cols="12" sm="4">
          ...
          <v-row class="mt-n5">
            <v-col cols="12" sm="4">
              <v-card class="rounded-xl ml-4" color="grey lighten-3" flat>
                ...
                <v-card-text class="">
                  A prototype is an early <br />sample, model or realease of a
                  product built to test a..
                </v-card-text>
        ...
        <v-col cols="12" sm="4">
          <v-card class="rounded-xl pa-4" color="grey lighten-3" flat>
            ...
            <v-app-bar color="rgba(0,0,0,0)" tile class="mt-3">
              ...
              <strong class="subtitle black--text ml-2">
                New Followers This Week <span class="caption"><br />972</span>
              </strong>
              <v-spacer></v-spacer>
              <v-icon color="grey" class="ml-2"
                >fas fa-chevron-circle-right</v-icon
            ...
            <v-card color="white" class="rounded-xl mx-4 pa-10" flat>
              <div class="text-center">
                <span
                  >Buy <strong>Pro Account</strong> to Explore <br />Premium
                  Features</span
                >
